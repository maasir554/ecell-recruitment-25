...
import { FaInstagram, FaFacebook, FaLinkedin, FaChevronRight  } from "react-icons/fa";
    ...
    >
      ...
      <div className="flex"> 
        <NavbarBrand as="li" className="gap-3 max-w-fit">
          <NextLink className="flex justify-start items-center gap-1" href="https://ecellnitb.in" target="_blank">
            <Image
              src="/logo.webp"
              alt="E-Cell NITB"
              width={40} 
      ...
      <NavbarMenu className="bg-gradient-to-b from-yellow-500/10 to-transparent overflow-hidden">
        <div className="mx-4 mt-2 flex flex-col gap-0">
          {siteConfig.navItems.map((item, index) => (
            <NavbarMenuItem key={`${item}-${index}`} className={"py-4 border-b-1 border-neutral-500/20 flex justify-between items-center "} >
              <Link
                color="foreground"
                href={item.href}
                size="lg"
